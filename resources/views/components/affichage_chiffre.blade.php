<div class="affichage-chiffree">
    <div class="expeditions">
        ...
        <div class="container">
            ...
            <div id="total-expeditions" class="container-item">
                <span class="labelle">Total</span>
                <span class="value"></span>
            </div>
            <div id="moyenne-expeditions" class="container-item">
                <span class="labelle">Moyenne(Avr/j)</span>
                <span class="value"></span>
            </div>
            <div id="min-expeditions" class="container-item">
                <span class="labelle">Min</span>
                <span class="value"></span>
            </div>
            <div id="max-expeditions" class="container-item">
    ...
    <div class="chiffre-affaire">
        ...
        <div class="container">
            <div id="total-chiffre-affaire" class="container-item">
                <span class="labelle">Total</span>
                <span class="value"></span>
            </div>
            <div id="moyenne-chiffre-affaire" class="container-item">
                <span class="labelle">Moyenne(Avr/j)</span>
                <span class="value"></span>
            </div>
            <div id="min-chiffre-affaire" class="container-item">
                <span class="labelle">Min</span>
                <span class="value"></span>
            </div>
            <div id="max-chiffre-affaire" class="container-item">
                <span class="labelle">Max</span>
                <span class="value"></span>
            </div>
        </div>
